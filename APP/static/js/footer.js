...
function openCreditsModal() {
    ...
    <div style="text-align: center;">
        <div style="font-size: 18px; text-align: left;">
            ...
            <p style="margin-bottom: 10px;"><strong>Frontend:</strong> <span style="color: #336699; transition: color 0.3s;" onmouseover="this.style.color='#ff9900'" onmouseout="this.style.color='#336699'">Hargitai Bence</span>, <span style="color: #336699; transition: color 0.3s;" onmouseover="this.style.color='#ff9900'" onmouseout="this.style.color='#336699'">Balla Botond</span></p>
