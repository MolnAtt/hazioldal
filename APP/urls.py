...
urlpatterns = [
    ...
    path('tanar/ellenorzes/<str:csoport>/', uj_tanar_ellenorzes_redirect, name='tanar_ellenorzes_redirect'),
    path('tanar/ellenorzes/<int:ev1>/<int:ev2>/<str:csoport>/', uj_tanar_ellenorzes, name='tanar_ellenorzes'),
    path('fiok/', fiok),
